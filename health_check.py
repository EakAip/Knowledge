...
# 重启8011, 8012, 8013, 8014, 7002服务

# 7998服务为gradio服务，暂时不适用。需要手动重启
...
SERVICES = [
    {"url": "http://localhost:8011/knowledge", "params": {"rpId": "test"}},
    {"url": "http://localhost:8012/postponement", "params": {"rpId": "test"}},
    {"url": "http://localhost:8013/link", "params": {"rpId": "test"}},
    {"url": "http://localhost:8014/knowledge", "params": {"rpId": "test"}},
    {"url": "http://localhost:7002/kc/resource/knowledgeCallBack", "params": {"rpId": "test"}}
]

# 配置重启命令
SERVICE_RESTART_COMMANDS = {
    8011: {
        "conda_env_path": "/home/wzhpc/anaconda3/envs/knowledge/bin/python",
        "script_path": "/opt/jyd01/wangruihua/api/knowledge/knowledge8011.py",
        "cuda_device": "0"
    },
    8012: {
        "conda_env_path": "/home/wzhpc/anaconda3/envs/knowledge/bin/python",
        "script_path": "/opt/jyd01/wangruihua/api/knowledge/knowledge8012.py",
        "cuda_device": "0"
    },
    8013: {
        "conda_env_path": "/home/wzhpc/anaconda3/envs/knowledge/bin/python",
        "script_path": "/opt/jyd01/wangruihua/api/knowledge/knowledge8013.py",
        "cuda_device": "0"
    },
    8014: {
        "conda_env_path": "/home/wzhpc/anaconda3/envs/knowledge/bin/python",
        "script_path": "/opt/jyd01/wangruihua/api/knowledge/knowledge8014.py",
        "cuda_device": "0"
    },
    7002: {
        "conda_env_path": "/home/wzhpc/anaconda3/envs/knowledge/bin/python",
        "script_path": "/opt/jyd01/wangruihua/api/knowledge/call_back7002.py",
        "cuda_device": "0"
    }
...
# 配置日志目录
LOG_DIR = "/opt/jyd01/wangruihua/api/knowledge/logs" 
